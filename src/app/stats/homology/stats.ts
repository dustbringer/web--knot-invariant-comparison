const stats: {
  ...
  ratios: {
    ...
    data: [
      ...
      [7, 100.0, 100.0, 100.0, 100.0],
      [8, 100.0, 100.0, 100.0, 100.0],
      [9, 100.0, 98.7503, 100.0, 100.0],
      [10, 100.0, 96.3388, 100.0, 99.1967],
      [11, 98.9026, 86.6246, 100.0, 99.6155],
      [12, 98.4462, 83.4267, 99.5569, NaN],
      [13, 94.5935, 73.3265, 99.144, NaN],
      [14, 93.4096, 66.6205, 98.5317, NaN],
      [15, 91.8437, 56.7367, 97.6482, NaN],
      [16, 90.3308, 47.8696, NaN, NaN],
      [17, 86.347, 40.0614, NaN, NaN],
      [18, 81.8611, 32.0171, NaN, NaN],
    ],
  },
});
