export const statsJones: {
  ...
  "count-monomial": {
    ylabel: "Number of polynomials with monomial jones mod p",
    xlabel: "Number of crossings",
    ylogscale: true,
    // yrange: [0, 100 + 5],
    legend: {
    ...
    ys: [
      ...
      [NaN, NaN, NaN, 1, 2, 2, 24, 85],
      [NaN, NaN, NaN, NaN, NaN, 1, 1, 4],
    ],
  },
  count: {
    ylabel: "Number of polynomials with jones = 1 mod p",
    xlabel: "Number of crossings",
    ylogscale: true,
    // yrange: [0, 100 + 5],
    legend: {
    ...
    x: [12, 13, 14, 15, 16, 17, 18, 19],
    ys: [
      [4, 13, 48, 188, 770, 3066, 12510, 52686],
      [1, 1, 2, 4, 30, 128, 492, 1808],
      [NaN, NaN, NaN, 1, 2, 2, 24, 85],
      [NaN, NaN, NaN, NaN, NaN, 1, 1, 4],
    ],
  },
  percentage: {
    ylabel: "Percentage of knots that have monomial jones mod p",
    xlabel: "Number of crossings",
    // ylogscale: true,
    // yrange: [0, 100 + 5],
    legend: {
...
export const statsKhovanov: {
  ...
  // },
  count: {
    ylabel: "Number of polynomials with kh = q+q^-1 mod p",
    xlabel: "Number of crossings",
    ylogscale: true,
    // yrange: [0, 100 + 5],
    legend: {
    ...
    ys: [
      [1, 1, 10, 42, 211, 870, 3442],
      [NaN, NaN, NaN, 1, 6, 26, 124],
      [NaN, NaN, NaN, NaN, NaN, NaN, 8],
    ],
  },
  percentage: {
    ylabel: "Percentage of knots that have kh = q+q^-1 mod p",
    xlabel: "Number of crossings",
    // ylogscale: true,
    // yrange: [0, 100 + 5],
    legend: {
    ...
    ys: [
      ...
      [NaN, NaN, NaN, 1 / 313230, 6 / 1701935, 26 / 8053393, 124 / 48266466],
      [NaN, NaN, NaN, NaN, NaN, NaN, 8 / 48266466],
    ],
  },
});
